  ...
  create or replace   view dev.dbt_dev_staging.stg_providers
...
SELECT 
    ...
    CASE 
        WHEN provider_sex_code IN ('M','m') THEN 'Male'
        WHEN provider_sex_code IN ('F','f') THEN 'Female'
        ELSE 'Unknown'
    ...
    CASE 
        WHEN CAST(provider_join_date AS DATE) IS NOT NULL THEN TRUE
        ELSE FALSE
